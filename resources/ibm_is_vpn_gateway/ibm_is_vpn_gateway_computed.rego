package ibmcloud.resources.computed.ibm_is_vpn_gateway
...
public_ip_address = ret {
    ret := {res.address: object.get(res.attributes, "public_ip_address", null) |
        res := resources_map[_]
        true
     }
}
public_ip_address2 = ret {
    ret := {res.address: object.get(res.attributes, "public_ip_address2", null) |
        res := resources_map[_]
        true
     }
}
