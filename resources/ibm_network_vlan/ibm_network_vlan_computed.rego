...
child_resource_count = ret {
    ret := {res.address: object.get(res.attributes, "child_resource_count", null) |
        res := resources_map[_]
        true
     }
}
...
vlan_number = ret {
    ret := {res.address: object.get(res.attributes, "vlan_number", null) |
        res := resources_map[_]
        true
     }
}
softlayer_managed = ret {
    ret := {res.address: object.get(res.attributes, "softlayer_managed", null) |
        res := resources_map[_]
        true
     }
}
