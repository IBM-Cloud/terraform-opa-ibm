package ibmcloud.resources.state.data.ibm_cd_toolchain_tool_githubintegrated
...
resources_map[attr]{
    attr := state.get_resources("ibm_cd_toolchain_tool_githubintegrated", "data").resources[_]
}
toolchain_crn = ret {
