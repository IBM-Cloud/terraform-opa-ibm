package ibmcloud.resources.state.data.ibm_satellite_cluster_worker_pool_zone_attachment
...
resources_map[attr]{
    attr := state.get_resources("ibm_satellite_cluster_worker_pool_zone_attachment", "data").resources[_]
}
