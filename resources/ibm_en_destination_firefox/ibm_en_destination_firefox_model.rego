package ibmcloud.resources.model.ibm_en_destination_firefox
...
resources_map[attr]{
    attr := plan.planned_values("ibm_en_destination_firefox").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_en_destination_firefox", "managed").resources[_]
}
name = ret {
