package ibmcloud.resources.computed.ibm_cd_toolchain_tool_secretsmanager
...
resources_map[attr]{
    attr := plan.changes_computed_values("ibm_cd_toolchain_tool_secretsmanager").resources[_]
}
toolchain_crn = ret {
