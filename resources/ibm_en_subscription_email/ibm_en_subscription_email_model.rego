package ibmcloud.resources.model.ibm_en_subscription_email
...
resources_map[attr]{
    attr := plan.planned_values("ibm_en_subscription_email").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_en_subscription_email", "managed").resources[_]
}
instance_guid = ret {
