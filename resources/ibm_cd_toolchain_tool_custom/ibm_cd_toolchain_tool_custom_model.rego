package ibmcloud.resources.model.ibm_cd_toolchain_tool_custom
...
resources_map[attr]{
    attr := plan.planned_values("ibm_cd_toolchain_tool_custom").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_cd_toolchain_tool_custom", "managed").resources[_]
}
href = ret {
