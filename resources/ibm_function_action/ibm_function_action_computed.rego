...
action_id = ret {
    ret := {res.address: object.get(res.attributes, "action_id", null) |
        res := resources_map[_]
        true
     }
}
target_endpoint_url = ret {
    ret := {res.address: object.get(res.attributes, "target_endpoint_url", null) |
        res := resources_map[_]
        true
     }
}
limits = ret {
    ret := {res.address: object.get(res.attributes, "limits", null) |
        res := resources_map[_]
        true
     }
}
