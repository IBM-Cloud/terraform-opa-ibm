...
config_dir = ret {
    ret := {res.address: object.get(res.attributes, "config_dir", null) |
        res := resources_map[_]
        true
     }
}
network = ret {
    ret := {res.address: object.get(res.attributes, "network", null) |
        res := resources_map[_]
        true
     }
}
...
download = ret {
    ret := {res.address: object.get(res.attributes, "download", null) |
        res := resources_map[_]
        true
     }
}
admin = ret {
    ret := {res.address: object.get(res.attributes, "admin", null) |
        res := resources_map[_]
        true
     }
}
