package ibmcloud.resources.computed.ibm_cd_toolchain_tool_privateworker
...
resources_map[attr]{
    attr := plan.changes_computed_values("ibm_cd_toolchain_tool_privateworker").resources[_]
}
href = ret {
