package ibmcloud.resources.model.ibm_cd_toolchain_tool_privateworker
...
resources_map[attr]{
    attr := plan.planned_values("ibm_cd_toolchain_tool_privateworker").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_cd_toolchain_tool_privateworker", "managed").resources[_]
}
parameters = ret {
