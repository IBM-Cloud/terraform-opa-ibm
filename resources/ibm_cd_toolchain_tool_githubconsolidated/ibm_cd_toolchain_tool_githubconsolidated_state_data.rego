package ibmcloud.resources.state.data.ibm_cd_toolchain_tool_githubconsolidated
...
resources_map[attr]{
    attr := state.get_resources("ibm_cd_toolchain_tool_githubconsolidated", "data").resources[_]
}
state = ret {
