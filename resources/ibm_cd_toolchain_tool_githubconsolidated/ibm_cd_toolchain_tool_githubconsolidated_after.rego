package ibmcloud.resources.after.ibm_cd_toolchain_tool_githubconsolidated
...
resources_map[attr]{
    attr := plan.changes_after_values("ibm_cd_toolchain_tool_githubconsolidated").resources[_]
}
parameters = ret {
