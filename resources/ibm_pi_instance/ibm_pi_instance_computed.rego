...
os_type = ret {
    ret := {res.address: object.get(res.attributes, "os_type", null) |
        res := resources_map[_]
        true
     }
}
...
min_processors = ret {
    ret := {res.address: object.get(res.attributes, "min_processors", null) |
        res := resources_map[_]
        true
     }
}
...
pin_policy = ret {
    ret := {res.address: object.get(res.attributes, "pin_policy", null) |
        res := resources_map[_]
        true
     }
}
migratable = ret {
    ret := {res.address: object.get(res.attributes, "migratable", null) |
        res := resources_map[_]
        true
     }
}
min_virtual_cores = ret {
    ret := {res.address: object.get(res.attributes, "min_virtual_cores", null) |
        res := resources_map[_]
        true
     }
}
max_processors = ret {
    ret := {res.address: object.get(res.attributes, "max_processors", null) |
        res := resources_map[_]
        true
     }
}
...
max_virtual_cores = ret {
    ret := {res.address: object.get(res.attributes, "max_virtual_cores", null) |
        res := resources_map[_]
        true
     }
}
...
max_memory = ret {
    ret := {res.address: object.get(res.attributes, "max_memory", null) |
        res := resources_map[_]
        true
     }
}
...
min_memory = ret {
    ret := {res.address: object.get(res.attributes, "min_memory", null) |
        res := resources_map[_]
        true
     }
}
...
health_status = ret {
    ret := {res.address: object.get(res.attributes, "health_status", null) |
        res := resources_map[_]
        true
     }
}
