package ibmcloud.resources.model.ibm_is_instance_volume_attachment
...
resources_map[attr]{
    attr := plan.planned_values("ibm_is_instance_volume_attachment").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_is_instance_volume_attachment", "managed").resources[_]
}
instance = ret {
