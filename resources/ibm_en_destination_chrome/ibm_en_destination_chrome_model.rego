package ibmcloud.resources.model.ibm_en_destination_chrome
import data.ibmcloud.tfplan as plan
import data.ibmcloud.state as state
# fetches the list of resource's attributes map.
resource_name_ = ret {
    ret := "ibm_en_destination_chrome"
}
resources_map[attr]{
    attr := plan.planned_values("ibm_en_destination_chrome").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_en_destination_chrome", "managed").resources[_]
}
instance_guid = ret {
