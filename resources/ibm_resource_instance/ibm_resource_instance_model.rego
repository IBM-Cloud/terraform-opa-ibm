package ibmcloud.resources.model.ibm_resource_instance
...
resources_map[attr]{
    attr := plan.planned_values("ibm_resource_instance").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_resource_instance", "managed").resources[_]
}
account_id = ret {
