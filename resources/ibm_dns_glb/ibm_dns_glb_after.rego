...
default_pools = ret {
    ret := {res.address: object.get(res.attributes, "default_pools", null) |
        res := resources_map[_]
        true
     }
}
az_pools = ret {
    ret := {res.address: object.get(res.attributes, "az_pools", null) |
        res := resources_map[_]
        true
     }
}
...
fallback_pool = ret {
    ret := {res.address: object.get(res.attributes, "fallback_pool", null) |
        res := resources_map[_]
        true
     }
}
