package ibmcloud.resources.model.ibm_container_vpc_alb_create
...
resources_map[attr]{
    attr := plan.planned_values("ibm_container_vpc_alb_create").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_container_vpc_alb_create", "managed").resources[_]
}
resize = ret {
