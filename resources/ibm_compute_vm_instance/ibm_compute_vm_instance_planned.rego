...
reserved_instance_primary_disk = ret {
    ret := {concat(".", [res.type, res.name]): object.get(res.attributes, "reserved_instance_primary_disk", null) |
        res := resources_map[_]
        true
     }
}
reserved_capacity_name = ret {
    ret := {concat(".", [res.type, res.name]): object.get(res.attributes, "reserved_capacity_name", null) |
        res := resources_map[_]
        true
     }
}
...
reserved_capacity_id = ret {
    ret := {concat(".", [res.type, res.name]): object.get(res.attributes, "reserved_capacity_id", null) |
        res := resources_map[_]
        true
     }
}
