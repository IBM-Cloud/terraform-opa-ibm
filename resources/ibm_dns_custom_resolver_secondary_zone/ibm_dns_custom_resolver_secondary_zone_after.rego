package ibmcloud.resources.after.ibm_dns_custom_resolver_secondary_zone
...
resources_map[attr]{
    attr := plan.changes_after_values("ibm_dns_custom_resolver_secondary_zone").resources[_]
}
zone = ret {
