package ibmcloud.resources.computed.ibm_cd_toolchain_tool_nexus
import data.ibmcloud.tfplan as plan
# fetches the list of resource's attributes map.
resource_name_ = ret {
    ret := "ibm_cd_toolchain_tool_nexus"
}
resources_map[attr]{
    attr := plan.changes_computed_values("ibm_cd_toolchain_tool_nexus").resources[_]
}
toolchain_crn = ret {
