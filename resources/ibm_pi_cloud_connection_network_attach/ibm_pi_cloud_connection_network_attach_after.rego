package ibmcloud.resources.after.ibm_pi_cloud_connection_network_attach
...
resources_map[attr]{
    attr := plan.changes_after_values("ibm_pi_cloud_connection_network_attach").resources[_]
}
