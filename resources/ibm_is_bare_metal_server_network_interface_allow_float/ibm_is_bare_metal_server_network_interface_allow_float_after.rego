package ibmcloud.resources.after.ibm_is_bare_metal_server_network_interface_allow_float
...
resources_map[attr]{
    attr := plan.changes_after_values("ibm_is_bare_metal_server_network_interface_allow_float").resources[_]
}
