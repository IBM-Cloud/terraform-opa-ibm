package ibmcloud.resources.computed.ibm_is_bare_metal_server_network_interface_allow_float
...
resources_map[attr]{
    attr := plan.changes_computed_values("ibm_is_bare_metal_server_network_interface_allow_float").resources[_]
}
resource_type = ret {
