package ibmcloud.resources.state.ibm_is_bare_metal_server_network_interface_allow_float
...
resources_map[attr]{
    attr := state.get_resources("ibm_is_bare_metal_server_network_interface_allow_float", "managed").resources[_]
}
status = ret {
