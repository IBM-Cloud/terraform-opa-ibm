...
public_ip_address_id = ret {
    ret := {res.address: object.get(res.attributes, "public_ip_address_id", null) |
        res := resources_map[_]
        true
     }
}
associated_vlans = ret {
    ret := {res.address: object.get(res.attributes, "associated_vlans", null) |
        res := resources_map[_]
        true
     }
}
private_ip_address_id = ret {
    ret := {res.address: object.get(res.attributes, "private_ip_address_id", null) |
        res := resources_map[_]
        true
     }
}
...
public_ipv6_address_id = ret {
    ret := {res.address: object.get(res.attributes, "public_ipv6_address_id", null) |
        res := resources_map[_]
        true
     }
}
