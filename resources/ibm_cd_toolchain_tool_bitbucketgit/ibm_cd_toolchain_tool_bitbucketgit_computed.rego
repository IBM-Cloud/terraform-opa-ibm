package ibmcloud.resources.computed.ibm_cd_toolchain_tool_bitbucketgit
...
resources_map[attr]{
    attr := plan.changes_computed_values("ibm_cd_toolchain_tool_bitbucketgit").resources[_]
}
toolchain_crn = ret {
