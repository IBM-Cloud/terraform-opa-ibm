package ibmcloud.resources.model.ibm_cd_toolchain_tool_pipeline
...
resources_map[attr]{
    attr := plan.planned_values("ibm_cd_toolchain_tool_pipeline").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_cd_toolchain_tool_pipeline", "managed").resources[_]
}
tool_id = ret {
