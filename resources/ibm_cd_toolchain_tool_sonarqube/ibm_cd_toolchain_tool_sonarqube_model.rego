package ibmcloud.resources.model.ibm_cd_toolchain_tool_sonarqube
import data.ibmcloud.tfplan as plan
import data.ibmcloud.state as state
# fetches the list of resource's attributes map.
resource_name_ = ret {
    ret := "ibm_cd_toolchain_tool_sonarqube"
}
resources_map[attr]{
    attr := plan.planned_values("ibm_cd_toolchain_tool_sonarqube").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_cd_toolchain_tool_sonarqube", "managed").resources[_]
}
crn = ret {
