package ibmcloud.resources.state.data.ibm_cd_toolchain_tool_devopsinsights
...
resources_map[attr]{
    attr := state.get_resources("ibm_cd_toolchain_tool_devopsinsights", "data").resources[_]
}
name = ret {
