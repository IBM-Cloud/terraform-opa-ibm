package ibmcloud.resources.computed.ibm_cd_toolchain_tool_devopsinsights
...
resources_map[attr]{
    attr := plan.changes_computed_values("ibm_cd_toolchain_tool_devopsinsights").resources[_]
}
href = ret {
