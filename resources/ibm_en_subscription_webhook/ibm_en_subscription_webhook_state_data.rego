package ibmcloud.resources.state.data.ibm_en_subscription_webhook
import data.ibmcloud.state as state
# fetches the list of resource's attributes map.
resource_name_ = ret {
    ret := "ibm_en_subscription_webhook"
}

resources_map[attr]{
    attr := state.get_resources("ibm_en_subscription_webhook", "data").resources[_]
}
destination_id = ret {
