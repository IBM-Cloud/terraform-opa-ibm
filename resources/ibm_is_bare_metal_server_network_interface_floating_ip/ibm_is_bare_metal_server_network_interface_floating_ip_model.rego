package ibmcloud.resources.model.ibm_is_bare_metal_server_network_interface_floating_ip
...
resources_map[attr]{
    attr := state.get_resources("ibm_is_bare_metal_server_network_interface_floating_ip", "managed").resources[_]
}
name = ret {
