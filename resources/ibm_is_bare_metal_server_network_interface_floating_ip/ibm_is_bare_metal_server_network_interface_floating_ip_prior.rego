package ibmcloud.resources.prior.ibm_is_bare_metal_server_network_interface_floating_ip
...
resources_map[attr]{
    attr := plan.prior_state_values("ibm_is_bare_metal_server_network_interface_floating_ip").resources[_]
}
floating_ip = ret {
