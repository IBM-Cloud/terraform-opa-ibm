package ibmcloud.resources.prior.ibm_cd_toolchain_tool_securitycompliance
...
resources_map[attr]{
    attr := plan.prior_state_values("ibm_cd_toolchain_tool_securitycompliance").resources[_]
}
tool_id = ret {
