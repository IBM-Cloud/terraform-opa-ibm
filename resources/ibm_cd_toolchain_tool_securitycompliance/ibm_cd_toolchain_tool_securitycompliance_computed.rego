package ibmcloud.resources.computed.ibm_cd_toolchain_tool_securitycompliance
...
resources_map[attr]{
    attr := plan.changes_computed_values("ibm_cd_toolchain_tool_securitycompliance").resources[_]
}
updated_at = ret {
