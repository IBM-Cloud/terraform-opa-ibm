package ibmcloud.resources.after.ibm_cd_toolchain_tool_securitycompliance
...
resources_map[attr]{
    attr := plan.changes_after_values("ibm_cd_toolchain_tool_securitycompliance").resources[_]
}
toolchain_id = ret {
