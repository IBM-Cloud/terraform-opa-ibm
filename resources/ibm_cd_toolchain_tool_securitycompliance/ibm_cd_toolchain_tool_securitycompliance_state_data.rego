package ibmcloud.resources.state.data.ibm_cd_toolchain_tool_securitycompliance
...
resources_map[attr]{
    attr := state.get_resources("ibm_cd_toolchain_tool_securitycompliance", "data").resources[_]
}
