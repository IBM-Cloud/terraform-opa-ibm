package ibmcloud.resources.computed.ibm_is_bare_metal_server_network_interface
...
resources_map[attr]{
    attr := plan.changes_computed_values("ibm_is_bare_metal_server_network_interface").resources[_]
}
floating_ips = ret {
