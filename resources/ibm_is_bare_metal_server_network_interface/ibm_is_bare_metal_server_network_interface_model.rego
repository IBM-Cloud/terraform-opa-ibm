package ibmcloud.resources.model.ibm_is_bare_metal_server_network_interface
...
resources_map[attr]{
    attr := plan.planned_values("ibm_is_bare_metal_server_network_interface").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_is_bare_metal_server_network_interface", "managed").resources[_]
}
floating_ips = ret {
