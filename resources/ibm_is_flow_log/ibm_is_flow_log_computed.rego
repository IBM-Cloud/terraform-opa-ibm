package ibmcloud.resources.computed.ibm_is_flow_log
...
resources_map[attr]{
    attr := plan.changes_computed_values("ibm_is_flow_log").resources[_]
}
crn = ret {
...
auto_delete = ret {
    ret := {res.address: object.get(res.attributes, "auto_delete", null) |
        res := resources_map[_]
        true
     }
}
