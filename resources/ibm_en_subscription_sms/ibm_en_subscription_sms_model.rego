package ibmcloud.resources.model.ibm_en_subscription_sms
import data.ibmcloud.tfplan as plan
import data.ibmcloud.state as state
# fetches the list of resource's attributes map.
resource_name_ = ret {
    ret := "ibm_en_subscription_sms"
}
resources_map[attr]{
    attr := plan.planned_values("ibm_en_subscription_sms").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_en_subscription_sms", "managed").resources[_]
}
instance_guid = ret {
