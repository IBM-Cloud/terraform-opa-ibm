package ibmcloud.resources.state.data.ibm_is_instance_network_interface_reserved_ip
...
resources_map[attr]{
    attr := state.get_resources("ibm_is_instance_network_interface_reserved_ip", "data").resources[_]
}
