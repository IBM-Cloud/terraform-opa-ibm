...
public_ipv4_address_id = ret {
    ret := {res.address: object.get(res.attributes, "public_ipv4_address_id", null) |
        res := resources_map[_]
        true
     }
}
...
public_ipv4_address = ret {
    ret := {res.address: object.get(res.attributes, "public_ipv4_address", null) |
        res := resources_map[_]
        true
     }
}
...
private_ipv4_address = ret {
    ret := {res.address: object.get(res.attributes, "private_ipv4_address", null) |
        res := resources_map[_]
        true
     }
}
...
private_ipv4_address_id = ret {
    ret := {res.address: object.get(res.attributes, "private_ipv4_address_id", null) |
        res := resources_map[_]
        true
     }
}
