package ibmcloud.resources.planned.ibm_cd_tekton_pipeline_trigger_property
...
resources_map[attr]{
    attr := plan.planned_values("ibm_cd_tekton_pipeline_trigger_property").resources[_]
}
path = ret {
