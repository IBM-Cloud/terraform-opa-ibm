package ibmcloud.resources.model.ibm_is_instance_action
...
resources_map[attr]{
    attr := plan.planned_values("ibm_is_instance_action").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_is_instance_action", "managed").resources[_]
}
status_reasons = ret {
