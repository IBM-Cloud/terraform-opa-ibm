package ibmcloud.resources.model.ibm_en_subscription_ios
import data.ibmcloud.tfplan as plan
import data.ibmcloud.state as state
# fetches the list of resource's attributes map.
resource_name_ = ret {
    ret := "ibm_en_subscription_ios"
}
resources_map[attr]{
    attr := plan.planned_values("ibm_en_subscription_ios").resources[_]
}
resources_map[attr]{
    attr := state.get_resources("ibm_en_subscription_ios", "managed").resources[_]
}
destination_id = ret {
