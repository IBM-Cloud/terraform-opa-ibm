package ibmcloud.resources.state.data.ibm_cd_toolchain_tool_hashicorpvault
...
resources_map[attr]{
    attr := state.get_resources("ibm_cd_toolchain_tool_hashicorpvault", "data").resources[_]
}
crn = ret {
