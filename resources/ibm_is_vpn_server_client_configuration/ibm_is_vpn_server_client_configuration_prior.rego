package ibmcloud.resources.prior.ibm_is_vpn_server_client_configuration
...
resources_map[attr]{
    attr := plan.prior_state_values("ibm_is_vpn_server_client_configuration").resources[_]
}
vpn_server = ret {
